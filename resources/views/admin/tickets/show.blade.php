                ...
                <div class="card card-one card-product">
                    <form class="card-body p-3 py-4">
                        ...
                        <div class="text-align-center">
                            <a href="{{route('admin.tickets.mail', $ticket)}}" class="btn btn-primary active my-5 px-5 text-ali">Submit </a>
                        </div>
                        @elseif($ticket->status_id == 7)
                        <div class="text-align-center">
                            <a href="{{route('admin.tickets.statusUpdate', $ticket)}}" class="btn btn-primary active my-5 px-5 text-ali">Submit </a>
                        </div>
                        @endif
                    </form>
                </div>
