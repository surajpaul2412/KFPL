...
class FormService
{
    ...
    private static function handleLICForm($ticket)
    {
      try {
        ...
        if (file_exists($filepath)) {
            ...
            $total_units =
                (float) $ticket->basket_size * (float) $ticket->basket_no;
            $total_units_in_float = (float) $total_units;

            $text = str_replace(
                "<!--SECURITYNAME-->",
                $ticket->security->name,
                $text
            );
            ...
            if ($ticket->type == 1) {
                ...
                $text = str_replace(
                    "<!--TICK-->",
                    '<div class="PURCHASETICK" style="position:absolute;bottom:494px;left:38px;"><span class="ff5 ws7" style="font-weight: bold;font-size: 11px;height: auto;display: inline-block;">ü</span></div>',
                    $text
                );
                $text = str_replace(
                    "<!--TOTALPURCHASEAMOUNT-->",
            ...
            if ($ticket->type == 2) {
                ...
                $text = str_replace(
                    "<!--TICK-->",
                    '<div class="REDEEMTICK" style="position:absolute;bottom:339px;left:38px;"><span class="ff5 ws7" style="font-weight: bold;font-size: 11px;height: auto;display: inline-block;">ü</span></div>',
                    $text
                );
                $text = str_replace(
                    "<!--TOTALUNITS-->",
                    $total_units_in_float,
                    $text
                );
                $text = str_replace(
                    "<!--TOTALREDEEMAMOUNT-->",
    ...
    private static function handleAXISForm($ticket)
    {
      try{
        ...
        $total_units =
            (float) $ticket->basket_size * (float) $ticket->basket_no;
        $total_units_in_float = (float) $total_units;
        $total_units_in_words = trim(
            self::NumberintoWords($total_units_in_float)
        ); // Total Units in Words
        $total_units_in_words =
            "" == $total_units_in_words
                ? "Zero Only"
                : $total_units_in_words . " Only";
        ...
        } elseif (strtolower($sec_name) == "axis nifty 50 etf") {
            $images[] = [
                "url" => $checkboxImageData,
                "x" => 20.94,
                "y" => 457.56,
        ...
        } elseif (strtolower($sec_name) == "axis nifty bank etf") {
            $images[] = [
                "url" => $checkboxImageData,
                "x" => 20.94,
                "y" => 476.51,
        ...
        } elseif (strtolower($sec_name) == "axis nifty it etf") {
            $images[] = [
                "url" => $checkboxImageData,
                "x" => 20.94,
                "y" => 494.63,
        ...
        } elseif (strtolower($sec_name) == "axis nifty healthcare etf") {
            $images[] = [
                "url" => $checkboxImageData,
                "x" => 20.94,
                "y" => 532.47,
        ...
        } elseif (strtolower($sec_name) == "axis nifty india consumption etf") {
            $images[] = [
                "url" => $checkboxImageData,
                "x" => 20.94,
                "y" => 551.42,
        ...
        } elseif (strtolower($sec_name) == "axis silver etf") {
            $images[] = [
                "url" => $checkboxImageData,
                "x" => 20.94,
                "y" => 571.19,
        ...
        } elseif (strtolower($sec_name) == "axis s&p bse sensex etf") {
            $images[] = [
                "url" => $checkboxImageData,
                "x" => 20.94,
                "y" => 590.14,
        ...
        // call API
        $urlToken =
            "filetoken://20949e2a0ccfa23f103c60e49f9a5742492ec2ad45e23bafc3";
        self::callAPIandSaveFile(
            $urlToken,
            $images,
            $textannotations,
            $ticket->id
    ...
    private static function handleBirlaFormNew($ticket)
    {
      try{
        ...
        if (strtolower($sec_name) == "aditya birla sun life nifty bank etf") {
        ...
        } elseif (strtolower($sec_name) == "aditya birla sun life gold etf") {
            $images[] = [
                "url" => $checkboxImageData,
                "x" => 35.58,
                "y" => 408.45,
            ...
            strtolower($sec_name) == "aditya birla sun life nifty 50 etf"
        ) {
            $images[] = [
                "url" => $checkboxImageData,
                "x" => 35.58,
        ...
        } elseif (strtolower($sec_name) == "aditya birla sun life silver etf") {
            $images[] = [
                "url" => $checkboxImageData,
                "x" => 35.58,
                "y" => 435.86,
            ...
            strtolower($sec_name) == "aditya birla sun life nifty next 50 etf"
        ) {
            $images[] = [
                "url" => $checkboxImageData,
                "x" => 35.58,
            ...
            strtolower($sec_name) == "aditya birla sun life nifty it etf"
        ) {
            $images[] = [
                "url" => $checkboxImageData,
                "x" => 35.58,
        ...
        $urlToken =
            "filetoken://170a15da3a9dba6242c1adc4c534efcc833d7d467c5f7de5c5";
        self::callAPIandSaveFile(
            $urlToken,
            $images,
            $textannotations,
            ...
            if ($found) {
                ...
                if ($ticket->type == 1) {
                    ...
                    if ($payment_type == 1) {
                        ...
                        $text = str_replace(
                            "<!--TRTYPEPURCHASECASH-->",
                            '<span class="ff3 ws3" style="display:inline-block;margin-left: 50px;position: absolute;">3</span>',
                            $text
                        );
                    }
                    ...
                    if ($payment_type == 2) {
                        // BASKET
                        $text = str_replace(
                            "<!--TRTYPEPURCHASEBASKET-->",
                            '<span class="ff3 ws3" style="display:inline-block;margin-left: 117px;position: absolute;">3</span>',
                            $text
                        );
                    }
                }
                ...
                if ($ticket->type == 2) {
                    ...
                    if ($payment_type == 1) {
                        ...
                        $text = str_replace(
                            "<!--TRTYPEREDEEMCASH-->",
                            '<span class="ff3 ws3" style="display:inline-block;margin-left:-48px;position: absolute;">3</span>',
                            $text
                        );
                    }
                    ...
                    if ($payment_type == 2) {
                        ...
                        $text = str_replace(
                            "<!--TRTYPEREDEEMBASKET-->",
                            '<span class="ff3 ws3" style="display:inline-block;margin-left:116px;position: absolute;">3</span>',
                            $text
                        );
                    }
                }
                ...
                $replace_str =
                    '<div class="c x17 w9 h11" style="bottom:' .
                    $bottom .
                    'px"><div class="t m0 x0 hf y50 ff7 fs3 fc2 sc0 ls0"><totalunits></div></div><div class="c x18 wa h11" style="bottom:' .
                    $bottom .
                    'px"><div class="t m0 x0 hf y50 ff7 fs3 fc2 sc0 ls0"><totalbaskets></div></div><div class="c x19 wb h11" style="bottom:' .
                    $bottom .
                    'px"><div class="t m0 x0 hf y50 ff7 fs3 fc2 sc0 ls0 wsb"><totalunitsinwords></div></div>';
                $basket_size = $ticket->basket_size;
                $ticket_basket = $ticket->basket_no; // NO. of Basket
                $total_units =
                    (float) $ticket->basket_size * (float) $ticket->basket_no;
                ...
                $word_text = trim(self::NumberintoWords($total_amt));
                $word_text =
                    "" == $word_text ? "Zero Only" : $word_text . " Only";
                $text = str_replace(
                    "<!--TOTALVALUEINWORDS-->",
                    $word_text,
                    $text
